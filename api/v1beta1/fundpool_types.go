...
// FundPool is the Schema for the fundpools API
...
// FundPoolList contains a list of FundPool
type FundPoolList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []FundPool `json:"items"`
}

func init() {
	SchemeBuilder.Register(&FundPool{}, &FundPoolList{})
}
